		...
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/pi.png">
			        <div class="thumb-image"> <img src="images/pi4.png" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			  </ul>
		</div>
	</div>	
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							<h1>Heading Out Wonderful</h1>
							<p>By Rober Golorick</p>
							<div class="star-on">
								<ul>
							...
							<div class="clearfix"> </div>
								...
								<label  class="add-to item_price">Rs.20</label>
			...
			<div class="content-top1">
				<div class="col-md-4 col-md3">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="si.php">Basic Computer Engineering</a></h3>
						<div class="price">
								<h5 class="item_price">Rs.66</h5>
				...
				<div class="product-bottom">
					...
					<div class="product-go">
						<div class=" fashion-grid">
							<a href="got.php"><img class="img-responsive " src="images/pr.jpg" alt=""></a>	
						</div>
						<div class=" fashion-grid1">
							<h6 class="best2"><a href="got.php" >Game Of Thrones</a></h6>
					...
					<div class="product-go">
						<div class=" fashion-grid">
							<a href="ce.php"><img class="img-responsive " src="images/pr1.jpg" alt=""></a>	
						</div>
						<div class=" fashion-grid1">
							<h6 class="best2"><a href="ce.php" >Civil Engineering</a></h6>
							<span class=" price-in1"> Rs.40.00</span>
						</div>	
						<div class="clearfix"> </div>
					</div>
					<div class="product-go">
						<div class=" fashion-grid">
							<a href="csc.php"><img class="img-responsive " src="images/pr2.jpg" alt=""></a>	
						</div>
						<div class=" fashion-grid1">
							<h6 class="best2"><a href="csc.php" >Computer Science</a></h6>
							<span class=" price-in1"> Rs.40.00</span>
						</div>	
						<div class="clearfix"> </div>
					</div>	
					<div class="product-go">
						<div class=" fashion-grid">
							<a href="lotr.php"><img class="img-responsive " src="images/pr3.jpg" alt=""></a>	
						</div>
						<div class=" fashion-grid1">
							<h6 class="best2"><a href="lotr.php" >Lord Of the rings </a></h6>
							<span class=" price-in1"> Rs.40.00</span>
						</div>	
						<div class="clearfix"> </div>
					</div>		
