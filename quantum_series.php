		...
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="images/pi.png">
			        <div class="thumb-image"> <img src="images/pi6.png" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			  </ul>
		</div>
	</div>	
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							...
							<div class="clearfix"> </div>
								...
								<label  class="add-to item_price">Rs.70</label>
